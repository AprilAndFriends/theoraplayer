...
namespace composite
{
	...
	void init()
	{
		...
		clipWater = theoraplayer::manager->createVideoClip(new theoraplayer::MemoryDataSource("media/locv/locv_water" + resourceExtension), theoraplayer::TH_RGB, 4);
		clipWater->setPlaybackSpeed(0.5f);
		clipWater->setAutoRestart(true);
		clipEve = theoraplayer::manager->createVideoClip(new theoraplayer::MemoryDataSource("media/locv/locv_eve" + resourceExtension), theoraplayer::TH_RGBA, 4);
