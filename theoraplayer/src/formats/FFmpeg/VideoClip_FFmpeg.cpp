...
namespace theoraplayer
{
	...
	VideoClip_FFmpeg::VideoClip_FFmpeg(DataSource* data_source,
	...
	VideoClip_FFmpeg::~VideoClip_FFmpeg()
	{
		unload();
	}

	void VideoClip_FFmpeg::load(DataSource* source)
	{
		mVideoStreamIndex = -1;
		mFrameNumber = 0;
	...
	bool VideoClip_FFmpeg::_readData()
	{
		return 1;
	}

	bool VideoClip_FFmpeg::decodeNextFrame()
	{
	...
	void VideoClip_FFmpeg::decodedAudioCheck()
	{
		if (mAudioInterface == NULL || mTimer->isPaused())
		{
			return;
		}
	...
	float VideoClip_FFmpeg::decodeAudio()
	{
		return -1;
	}

	void VideoClip_FFmpeg::doSeek()
	{

	}

	void VideoClip_FFmpeg::_restart()
	{
