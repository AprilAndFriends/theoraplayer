...
#ifndef THEORA_VIDEOCLIP_H
#define THEORA_VIDEOCLIP_H
...
public:
	...
	//! benchmark function
	int getNumDisplayedFrames() { return this->numDisplayedFrames; }
	//! benchmark function
	int getNumDroppedFrames() { return this->numDroppedFrames; }
...
protected:
	...
	// benchmark vars
	int numDroppedFrames, numDisplayedFrames, numPrecachedFrames;
