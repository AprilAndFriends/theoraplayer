...
// Cateia Games note: function copied and adapted from vorbis for compatibility
const char *vorbis_version_string(void){
	return "tremor (svn_rev18154)";
}

// Cateia Games note: function copied from vorbis for compatibility
